...
export default function Header({ 
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between">
      ...
      {/* Acciones Rápidas: Botón de Metas / Excel / Perfil */}
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        
        {/* BOTÓN RÁPIDO DE METAS Y KPIS DIARIOS */}
        <button
          type="button"
          onClick={onAbrirKpis}
        ...
        {/* Exportar a Excel Power BI (Solo Director/Admin) */}
        {esDirector && (
          <button
            type="button"
            ...
            title="Exportar base de datos para Power BI y Excel">
